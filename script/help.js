...
module.exports["run"] = async ({
    ...
    if (!input) {
        ...
        helpMessage += `\n bKash NO: +8801704407109. If you'd like to support us and keep our server running 24/7, please consider donating.\n\n`;
...
module.exports["handleEvent"] = async ({
    ...
    try {
        ...
        const message = prefix ? `PREFIX > ["${prefix}"]`: `AI SYSTEM > ["NO PREFIX"]`;
